...
ENV PICK_VERSION_SPEC_FILE_FROM_HOME "rpmbuild/SPECS/pick.spec"
...
USER rpmbuild
RUN cp pick.spec.tmpl "$PICK_VERSION_SPEC_FILE_FROM_HOME" \
 ...
 && chmod 644 "$PICK_VERSION_SPEC_FILE_FROM_HOME"
